...
from data.test_data10 import test_batch
...
Regularazition_Rate = 0.0006
Training_Steps = 1025  # 裁剪后的数据量为12311/12 = 1025
bn_decay = 0.9
Moving_Average_Decay = 0.99
Model_Save_Path = "CNN10_BN_v"
...
def train(train, label, num):
	...
	with tf.Session() as sess:
		writer = tf.summary.FileWriter("CNN10_BN_v" + str(num) + "_logs/", sess.graph)
...
def main(argv=None):
	...
	mean = evaluate(x_test, y_test, 461, 3) #batnum = len(test)/4  461 187.5
	print(np.mean(mean))
