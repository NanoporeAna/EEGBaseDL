...
Model_Save_Path = "H:/SpaceWork/CNN-LSTM/MODELS/CNNLSTM5min_v2"
...
def sum(num):
    _conv1, _pool1, _conv2, _pool2, _conv3, _pool3, _conv4, _pool4, _lstm = evaluate(num)
    name = [_conv1, _pool1,  _conv2, _pool2, _conv3, _pool3, _conv4, _pool4, _lstm]
    ...
    sio.savemat('D:/EEG_WorkSpace5min/CNNLSTM/delta/'+str(num)+'.mat', {name1[0]:channel[0], name1[1]:channel[1], name1[2]:channel[2],
