...
from data.load_alpha_data import load_alpha_data, load_alpha_data_pool1, load_alpha_data_pool2, load_alpha_data_pool3, \
...
def sum(num):
    ...
    sio.savemat('D:/EEG_WorkSpace/NIHSS/data_corr/alpha/'+str(num)+'.mat', {name1[0]:channel[0], name1[1]:channel[1], name1[2]:channel[2], name1[3]:channel[3], name1[4]:channel[4],name1[5]:channel[5],name1[6]:channel[6],name1[7]:channel[7]})
