...
return (2686, 6000, 9)的样本集和（2686）便签集  2430
"""
...
def tailor_train_batch():
	...
	# 	for j in range(2, int(shape[i] / 6000)):
	...
	for j in range(int(shape[0] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[1] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix1[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[2] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix2[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[3] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix3[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[4] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix4[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[5] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix5[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[6] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix6[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[7] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix7[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[8] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix8[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[9] / 12000) - 1):
		for i in range(1, 41):
			batchx = load_matrix9[j * 6000 + i * 257:(j + 1) * 6000 + i * 257]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[10] / 12000) - 1):
		for i in range(1, 51):
			batchx = load_matrix10[j * 6000 + i * 237:(j + 1) * 6000 + i * 237]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[11] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix11[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[12] / 12000)):
		for i in range(1, 41):
			batchx = load_matrix12[j * 6000 + i * 257:(j + 1) * 6000 + i * 257]
			batch = np.reshape(batchx, (6000, 9))
	...
	for j in range(int(shape[13] / 12000) - 1):
		for i in range(1, 11):
			batchx = load_matrix13[j * 6000 + i * 1073:(j + 1) * 6000 + i * 1073]
			batch = np.reshape(batchx, (6000, 9))
...
#  对15号样本进行裁剪增加120倍数据集，平衡数据
	for j in range(int(shape[14] / 12000)):
		for i in range(1, 121):
			batchx = load_matrix14[j * 6000 + i * 97:(j + 1) * 6000 + i * 97]
			batch = np.reshape(batchx, (6000, 9))
