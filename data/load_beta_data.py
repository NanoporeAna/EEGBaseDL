...
def load_beta_data_pool4(path,count):
    ...
    for j in range(0, flg):
        for i in range(0, 31):
            # tem = (beta_data[j * 500 + i * 16] + beta_data[j * 500 + i * 16 + 1] + beta_data[j * 500 + i * 16 + 2] +
            #        beta_data[j * 500 + i * 16 + 3] + beta_data[j * 500 + i * 16 + 4] +
            #        beta_data[j * 500 + i * 16 + 5] + beta_data[j * 500 + i * 16 + 6] + beta_data[
            #            j * 500 + i * 16 + 7] + beta_data[j * 500 + i * 16 + 8] + beta_data[j * 500 + i * 16 + 9] +
            #        beta_data[j * 500 + i * 16 + 10] + beta_data[j * 500 + i * 16 + 11] + beta_data[
            #            j * 500 + i * 16 + 12] +
            #        beta_data[j * 500 + i * 16 + 13] + beta_data[j * 500 + i * 16 + 14] + beta_data[
            #            j * 500 + i * 16 + 15]) / 16
            # temp.append(tem)
            tem = (beta_data[j * 500 + i * 16] + beta_data[j * 500 + i * 16 + 1] + beta_data[j * 500 + i * 16 + 2] +
                   beta_data[j * 500 + i * 16 + 3] + beta_data[j * 500 + i * 16 + 4] +
                   ...
                   beta_data[j * 500 + i * 16 + 10] + beta_data[j * 500 + i * 16 + 11] + beta_data[
                       j * 500 + i * 16 + 12] +
                   beta_data[j * 500 + i * 16 + 13] + beta_data[j * 500 + i * 16 + 14]+ beta_data[j * 500 + i * 16 + 15]) / 16
            temp.append(tem)
        flag = (beta_data[j * 500 + 496] + beta_data[j * 500 + 497] + beta_data[j * 500 + 498] + beta_data[
            j * 500 + 499]) / 4
        temp.append(flag)
