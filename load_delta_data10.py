...
with open("H:/SpaceWork/CNN-LSTM/Delta_path10") as file_object: #在这里选择什么频带数据
...
'''
def load_delta_data_conv2(path,count):
    #path 表示第几个实验者，count表示要处理的通道
    temp = []
    delta_data = build_single_delta(path, count)
    shape = delta_data.size
    flg = int(shape / 5000)
    for j in range(0, flg):
        for i in range(0, 2496):
            tem = (delta_data[j * 5000 +i*2]+delta_data[j * 5000 +i*2+1]+delta_data[j * 5000 +i*2+2]+delta_data[j * 5000 +i*2+3]+delta_data[j * 5000 +i*2+4]+
                   delta_data[j * 5000 +i*2+5]+delta_data[j * 5000 +i*2+6]+delta_data[j * 5000 +i*2+7]+delta_data[j * 5000 +i*2+8])/9
            temp.append(tem)
        temp.append((delta_data[j * 5000 + 4992] + delta_data[j * 5000 + 4993] + delta_data[j * 5000 + 4994] +delta_data[j * 5000 + 4995]+
                     delta_data[j * 5000 + 4996] + delta_data[j * 5000 + 4997] + delta_data[j * 5000 + 4998] +delta_data[j * 5000 + 4999]) / 8)
        temp.append((delta_data[j * 5000 + 4994] +delta_data[j * 5000 + 4995]+delta_data[j * 5000 + 4996] + delta_data[j * 5000 + 4997] + delta_data[j * 5000 + 4998] +delta_data[j * 5000 + 4999]) / 6)
        temp.append((delta_data[j * 5000 + 4996] +delta_data[j * 5000 + 4997] + delta_data[j * 5000 + 4998] + delta_data[j * 5000 + 4999]) / 4)
        temp.append((delta_data[j * 5000 + 4998] +delta_data[j * 5000 + 4999]) / 2)
    data =np.array(temp)
    return data
    '''
