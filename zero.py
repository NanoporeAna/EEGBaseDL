...
def delt():
	for i in range(0,15):
		...
		sio.savemat('D:/label_corr/NIHSS/temp/'+str(i)+'.mat', {CNN[0]:array0, CNN[1]:array1, CNN[2]:array2, CNN[3]:array3, CNN[4]:array4, CNN[5]:array5, CNN[6]:array6, CNN[7]:array7 })
