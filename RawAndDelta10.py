...
from DATA.load_delta_data10 import load_delta_data_conv1, load_delta_data_pool1, load_delta_data_conv2, \
...
def sum(num):
    ...
    sio.savemat('D:/EEG_WorkSpace10/MRS/data_corr/temp/'+str(num)+'.mat', {name1[0]:channel[0], name1[1]:channel[1], name1[2]:channel[2],name1[3]:channel[3], name1[4]:channel[4], name1[5]:channel[5], name1[6]:channel[6], name1[7]:channel[7]})
