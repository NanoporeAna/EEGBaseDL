...
path = 'D:/maxCorr/delta10/'
path1 = 'D:/EEG_WorkSpace10/MRS/raw_data_corr_max/'
def eliminate_corr():
	for i in range(0,15):
		...
		sio.savemat('D:/EEG_WorkSpace10/MRS/data_corr/maxabs_delta/'+str(i)+'.mat', {CNN[0]:array0, CNN[1]:array1, CNN[2]:array2, CNN[3]:array3, CNN[4]:array4, CNN[5]:array5, CNN[6]:array6, CNN[7]:array7 })
